...
- Backend: **1180 tests passing** + abn-security Go suite all-green (V1 baseline 939, then per-batch additions through Batch 22A; full per-batch accounting in the dated entries below), V1 feature-complete
